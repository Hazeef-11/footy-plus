...
const PlayerDetails = () => {
  let { id } = useParams();
  let { data, error, loading } = ApiFetch(
    `https://footyplus-api-1.onrender.com/playerDetails/${id}`,
  );
  ...
  return (
    <>
      ...
      <div className="player-card">
        ...
        <p>
          <span>Country:</span> {data.nationality}{" "}
        </p>
        <p>
        ...
        <p>
          <span>Current Team: </span> {data.team}
        </p>
        <p>
          {" "}
          <span>Birthday:</span> {data.birthday}
        </p>
