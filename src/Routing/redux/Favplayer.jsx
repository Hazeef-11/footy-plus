...
let dispatch=useDispatch()
    ...
    let favplayer=useSelector((player)=>{ return player.cart})
        ...
        {favplayer.map((db) =>(
          ...
          >
            ...
            <Card.Body className="mild">
              ...
              <Card.Text style={{marginTop:"-10px"}}>Position : {db.position}</Card.Text>
              ...
              <div>
                ...
                <button className="favplayerbutton" onClick={()=>handleDelete(db)}><FaTrash/><br />Delete</button>
