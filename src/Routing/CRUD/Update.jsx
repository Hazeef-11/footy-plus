...
const Update = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://footyplus-api-1.onrender.com/players/${id}`)
  ...
  let handleAll = (e) => {
    ...
    axios
      .put(`https://footyplus-api-1.onrender.com/players/${id}`, updatedata)
      .then(() =>
        Swal.fire({
    ...
    <div>
      ...
      <div className="updateform1">
        ...
        <div>
          ...
          <input
            name="name"
            style={{ margin: " 20px 5px", padding: "5px" }}
            placeholder="Name"
        ...
        <button className="updatebutton" onClick={handleAll}>
          Update
        </button>
      </div>
    </div>
