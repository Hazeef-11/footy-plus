...
const BundesligaTeam = () => {
    ...
    let {data,error,loading,setData}=ApiFetch(`https://footyplus-api-1.onrender.com/bundesligaTeams/${id}`)
      ...
      <div className="honours">
        ...
        <div className="honours-grid">
          <div className="honour-item">
            ...
            <h5>Bundesliga Titles</h5>
            <h3>{data.bundesliga}</h3>
          </div>
          <div className="honour-item">
            
            <h5>DFB-Pokal - Titles</h5>
            <h3>{data.dflSupercup}</h3>
          </div>
          <div className="honour-item">
