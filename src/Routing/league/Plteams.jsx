...
const Plteams = () => {
    ...
    let {data,error,loading,setData}=ApiFetch(`https://footyplus-api-1.onrender.com/plteams/${id}`)
      ...
      <div className="honours">
        ...
        <div className="honours-grid">
          <div className="honour-item">
            ...
            <h5>Premier League Titles</h5>
            <h3>{data.premierLeague}</h3>
          </div>
          <div className="honour-item">
            
            <h5>League Cup -Titles</h5>
            <h3>{data.leagueCup}</h3>
          </div>
          <div className="honour-item">
