      ...
      <div className="mainsearch">
        <input
          ...
          placeholder="Search Teams......."
           style={{ padding: "10px 200px 10px 20px" , borderRadius:"10px", border:"3px solid black", boxShadow:"1px 0px 10px #00c6ff",outline:"none"}}
        ...
        {find.map((db) => (
          ...
          >
            ...
            <Card.Body className="mild">
              ...
              <Link to={`/ligue1teams/${db.id}`} style={{color:"white", textDecoration:"none"}}> 
              Team Details ➜</Link>
              </button>
            </Card.Body>
          </Card>
